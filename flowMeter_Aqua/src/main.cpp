...
// YF-S201 calibration factor (pulses per liter)
// Typical value: ~450 pulses/liter (may need calibration)
...
void setup() {
  ...
  IPAddress local_IP(192, 168, 0, 77);  // Fixed IP address
  IPAddress gateway(192, 168, 0, 1);    // Your router's gateway (usually .1)
